...
_pinfo_tester:     file format elf32-i386
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 427:	f7 f1                	div    %ecx
 429:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 80 08 00 00       	mov    $0x880,%ebx
        while(*s != 0){
