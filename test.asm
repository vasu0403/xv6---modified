...
int main(int argc, char *argv[]) {
  ...
  2d:	7d 24                	jge    53 <main+0x53>
        ...
        id = fork();
  2f:	e8 86 02 00 00       	call   2ba <fork>

        if(id == 0)
  34:	85 c0                	test   %eax,%eax
  36:	75 f0                	jne    28 <main+0x28>
            // sleep(2);
            // sleep(2);
            // sleep(2);
            // sleep(2);
  ...
  43:	e8 08 02 00 00       	call   250 <atoi>
    for (k = 0; k < n; k++) {
  ...
  4d:	89 c6                	mov    %eax,%esi
    for (k = 0; k < n; k++) {
  4f:	7f cf                	jg     20 <main+0x20>
  51:	eb e5                	jmp    38 <main+0x38>
        }
    }
    for (k = 0; k < n; k++) {
  ...
  58:	83 c3 01             	add    $0x1,%ebx
        ...
        // waitx(&a, &b);
        wait();
  5b:	e8 6a 02 00 00       	call   2ca <wait>
    for (k = 0; k < n; k++) {
  60:	39 f3                	cmp    %esi,%ebx
  62:	75 f4                	jne    58 <main+0x58>
  64:	eb d2                	jmp    38 <main+0x38>
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
