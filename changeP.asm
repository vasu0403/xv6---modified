...
_changeP:     file format elf32-i386
  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  55:	52                   	push   %edx
  56:	50                   	push   %eax
  57:	68 b2 07 00 00       	push   $0x7b2
  5c:	6a 01                	push   $0x1
  5e:	e8 cd 03 00 00       	call   430 <printf>
	exit();
  63:	e8 6a 02 00 00       	call   2d2 <exit>
		printf(1, "Invalid pid\n");
  68:	51                   	push   %ecx
  69:	51                   	push   %ecx
  6a:	68 a5 07 00 00       	push   $0x7a5
  6f:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb c9 07 00 00       	mov    $0x7c9,%ebx
        while(*s != 0){
